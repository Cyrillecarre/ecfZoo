...
class VeterinaryControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'veterinary[email]' => 'Testing',
            'veterinary[roles]' => 'Testing',
            'veterinary[password]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'veterinary[email]' => 'Something New',
            'veterinary[roles]' => 'Something New',
            'veterinary[password]' => 'Something New',
        ]);
